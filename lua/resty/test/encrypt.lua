...
if key == nil or key == "" or price == nil or price == "" then
    return nil
end
if #key < 32 then
    local count = 32 - #key
...
local encrypted = aes_128_cbc_with_iv:encrypt(price)
encrypted = ngx.encode_base64(encrypted)
encrypted = ngx.escape_uri(encrypted)
...
local response = "price:  "..price.."\n\rtoken:  "..token.."\n\riv:  "..iv.."\n\rprice_encrypt:  "..encrypted.."\n\rprice_decrypt:  "..decrypt
ngx.say(response)
